    ...
    <div class="container">
        <form action="{{ route('baju.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('warna') is-invalid @enderror" id="warna" name="warna" value="{{ $baju->warna }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah"
                    name="jumlah" value="{{ $baju->jumlah }}" placeholder="Jumlah..." required>
                @error('jumlah')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
